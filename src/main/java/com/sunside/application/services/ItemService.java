...
public class ItemService {
    ...
    public void deleteFiles(Item item){
        awsService.deleteFile(item.getVideo());
        awsService.deleteFile(item.getAudio());
        awsService.deleteFile(item.getImage());
    }

    public void saveFiles(ItemDTORequest request, Item item){
        awsService.saveFile(item.getVideo(), request.video());
        awsService.saveFile(item.getAudio(), request.audio());
        awsService.saveFile(item.getImage(), request.image());
    }
